...
class AuthViewModel: ObservableObject {
    ...
    /// 애플 회원가입
    func appleRegister(idToken: String,
                       email: String?,
                       phoneNumber: String?,
                       nickname: String,
                       gender: String,
        ...
        AuthApiService.appleRegister(idToken: idToken, email: email, nickname: nickname, phoneNumber: phoneNumber, gender: gender, birthday: birthday)
            .sink { apiCompletion in
                switch apiCompletion {
                case .finished:
                    print("회원가입(애플) 완료")
